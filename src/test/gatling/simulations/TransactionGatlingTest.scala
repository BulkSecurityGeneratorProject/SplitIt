...
class TransactionGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("SplitItapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Transaction entity")
        ...
        .formParam("client_id", "SplitItapp")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "date":"2020-01-01T00:00:00.000Z", "value":null}""")).asJSON
            .check(status.is(201))
